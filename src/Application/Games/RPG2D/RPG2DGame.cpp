...
namespace RPG2D {
    ...
    RPG2DGame::RPG2DGame(App& app, Camera& focusCamera)
    : mApp_(app), mCameraController_(&focusCamera, mApp_.getWindow().getInputHandler()), 
    mInputHandler_(app.getWindow().getInputHandler()) {}
