...
BasicScene::BasicScene(App& theApp)
    ...
    assimpModel_.loadMesh("./res/Sphere.obj");
    ...
    // Third Entity (Floor)
    Entity* floorEntity = new Entity(*this);
    ...
    Entity* assimpEntity = new Entity(*this);
    ModelRenderable* assimpRenderable = new ModelRenderable(&assimpModel_, Shader::getLoadedShader("Assimp"));
    assimpEntity->addRenderable(assimpRenderable);
    assimpEntity->setPosition({0.f, 5.f, 0.f});
    mEntities_.push_back(assimpEntity);
}
